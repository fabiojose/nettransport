...
public class JHexEditorASCII extends JComponent implements MouseListener,KeyListener
{
    ...
    public void paint(Graphics g)
    {
        ...
        for(int n=ini;n<fin;n++)
        {
            ...
            String s=""+new Character((char)he.buffer[n]);
            if((he.buffer[n]<20)||(he.buffer[n]>126)) s=""+(char)16;
    ...
    public void keyTyped(KeyEvent e)
    {
        ...
        he.buffer[he.cursor]=(byte)e.getKeyChar();

        if(he.cursor!=(he.buffer.length-1)) he.cursor++;
        he.repaint();
    }
